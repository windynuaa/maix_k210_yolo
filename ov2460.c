...
uint16_t *k210_dataBuffer;
uint8_t *k210_aiBuffer;
...
int dvpInit(uint32_t freq)
{
	...
	iomem_free(k210_dataBuffer);
	iomem_free(k210_aiBuffer);
	k210_aiBuffer  = (uint8_t*)iomem_malloc(76800*3);
	k210_dataBuffer= (uint16_t*)iomem_malloc(76800*2);
	printf("aibuffer: %p\n",k210_aiBuffer);
